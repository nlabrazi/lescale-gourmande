...
export const useSiteLinks = (): SiteLink[] => [
  ...
  { label: 'Notre histoire', to: '/about-page', isNuxtLink: true, showInNav: true, showInFooter: true },
  { label: 'Nos créations', to: '/creations', isNuxtLink: true, showInNav: true, showInFooter: true },
  { label: 'Contact', to: '/contact-page', isNuxtLink: true, showInNav: true, showInFooter: true },
  { label: 'Blog', href: 'https://medium.com/@lescalegourmande', isNuxtLink: false, target: '_blank', rel: 'noopener', showInNav: false, showInFooter: true }
]
